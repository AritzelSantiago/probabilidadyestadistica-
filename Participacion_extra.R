...
#    Agrupan los valores para la variable Petal.Width 
#    y se calcula la frecuencia absoluta.

tabla_PL<-as.data.frame(table(PL = iris$Petal.Width))


# 2.- Frecuencia absoluta de la variable Petal.Width (PW)
#    Se muestra la tabla de contingencia para la variable PW
